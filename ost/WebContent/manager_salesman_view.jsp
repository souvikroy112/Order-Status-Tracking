					...
					<div class="tab-pane fade in active" id="view">
                        ...
                        else
                        {
                        	...
                        	<table>
                        		<tr>
                        			<td>Id</td>
                        			<td><%=session.getAttribute("salmn_id") %></td>
                        		</tr>
                        		<tr>
                        			<td>Name</td>
                        			<td><%=session.getAttribute("salmn_name") %></td>
                        		</tr>
                        		<tr>
                        			<td>Date Of Birth</td>
                        			<td><%=session.getAttribute("salmn_dob") %></td>
                        		</tr>
                        		<tr>
                        			<td>City</td>
                        			<td><%=session.getAttribute("salmn_city") %></td>
                        		</tr>
                        		<tr>
                        			<td>Contact</td>
                        			<td><%=session.getAttribute("salmn_contact") %></td>
                        		</tr>
                        		<tr>
                        			<td>Email</td>
                        			<td><%=session.getAttribute("salmn_email") %></td>
                        		</tr>
                        	</table>
                        	<a href="manager_salesman_update.jsp" class="btn btn-default">Update
