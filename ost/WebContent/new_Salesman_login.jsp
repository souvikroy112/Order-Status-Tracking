					...
					<div class="tab-pane fade in active" id="change_password">
						<div class="media">
							<div class="media-body">
								<form role="form" action="changePasswordNewSalesman" method="post" name="form_login" onsubmit="return validateClient();">
									<div class="form-group">
										<input type="password" class="form-control" id="salesman_password" name="Password" placeholder="Password" required="required">
									</div>
